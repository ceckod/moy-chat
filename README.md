...
**Версия:** 1.30.0
**Последна промяна:** 2026-08-13 (Europe/Sofia) — 🆕 Suno Audio Preview Player (нов инструмент в "Инструменти" — вграден браузърен плейър за preview на Suno AI output, без сваляне) — виж Changelog
...
> 🧭 **AI модел, отварящ този проект за първи път в нов разговор:**
> прочети `PROJECT_STATE.md` първо — там е всичко нужно, за да продължиш
> без да четеш целия сайт или да питаш потребителя за контекст.
