...
**Версия:** 1.27.0
**Последна промяна:** 2026-08-11 (Europe/Sofia) — Пълноценна AI-агент интеграция: безплатна обложка (Pollinations, без ключ), по-естествен/по-малко "AI-звучащ" текст на песента (Claude приоритет), автоматични синхронизирани субтитри (Groq Whisper) с авто-прикачване към YouTube — виж Changelog
