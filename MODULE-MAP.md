...
**Последно физически проверена срещу реалните файлове:** 2026-08-15
(виж `PROJECT_STATE.md` за протокола, който пази тази карта вярна занапред).
...
## 12. Мъртъв код — почистен (последно потвърдено 2026-08-15)

Списъкът по-долу вече НЕ съществува в repo-то (проверено физически на
2026-08-15 — предходен запис "изтрит на 2026-08-13" беше грешен: файловете
бяха документирани като изтрити в README/changelog, но реално оцеляха в
следващ ZIP upload; `npm test` = 85/85 след повторното изтриване).
